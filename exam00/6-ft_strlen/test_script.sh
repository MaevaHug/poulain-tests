...
cc -Wall -Wextra -Werror -o ft_strlen main.c ft_strlen.c
if [ $? -ne 0 ]; then
...
longest_test="$> ./ft_strlen \"This is a test string.\""
...
run_test "a" "1" || all_tests_passed=false
run_test "hello" "5" || all_tests_passed=false
run_test "42" "2" || all_tests_passed=false
run_test "This is a test string." "22" || all_tests_passed=false
