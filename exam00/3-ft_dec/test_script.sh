...
cc -Wall -Wextra -Werror main.c ft_dec.c -o program
if [ $? -ne 0 ]; then
...
longest_test="Testing ft_dec with value 42"
...
run_test() {
	...
	echo "$separator"
	echo "Testing ft_dec with value 42"
...
run_test "41" || all_tests_passed=false
