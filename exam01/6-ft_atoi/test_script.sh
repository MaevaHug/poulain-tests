...
cc -Wall -Wextra -Werror -o ft_atoi main.c ft_atoi.c
if [ $? -ne 0 ]; then
...
longest_test="$> ./ft_atoi \"-2147483648\""
...
run_test "   123" "123" || all_tests_passed=false
run_test "   -123" "-123" || all_tests_passed=false
run_test "+123" "123" || all_tests_passed=false
run_test "   +123" "123" || all_tests_passed=false
run_test "123abc" "123" || all_tests_passed=false
run_test "abc123" "0" || all_tests_passed=false
