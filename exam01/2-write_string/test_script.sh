...
cc -Wall -Wextra -Werror -o write_string main.c write_string.c
if [ $? -ne 0 ]; then
...
longest_test="$> ./write_string \"This is a test string.\" | cat -e"
...
run_test() {
	...
	echo "$separator"
	echo "$> ./write_string $args | cat -e"

	output=$(eval ./write_string $args | cat -e)
