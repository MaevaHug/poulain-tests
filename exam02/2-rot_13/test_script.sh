...
cc -Wall -Wextra -Werror -o rot_13 rot_13.c
if [ $? -ne 0 ]; then
...
longest_test="$> ./rot_13 \"My horse is Amazing.\" | cat -e"
...
run_test() {
	...
	echo "$separator"
	echo "$> ./rot_13 $args | cat -e"

	output=$(eval ./rot_13 $args | cat -e)
...
# Test cases
run_test "\"abc\"" "nop\$" || all_tests_passed=false
run_test "\"My horse is Amazing.\"" "Zl ubefr vf Nznmvat.\$" || all_tests_passed=false
run_test "\"AkjhZ zLKIJz , 23y \"" "NxwuM mYXVWm , 23l \$" || all_tests_passed=false
